# Build a Governed Conversational Analytics Experience with Databricks Genie
...
### Start Here
1. [Overview](01-lab-overview.md) — duration, prerequisites, final artifact statement
2. [Company Profile](02-company-profile.md) — fictional company, data model, roles, naming conventions
3. [Narrative Arc](03-narrative-arc.md) — the story this lab tells, module dependency map
...
*This lab is a training/portfolio artifact and is not affiliated with or endorsed by Databricks.*
